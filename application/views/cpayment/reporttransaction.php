                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="card page-header">
                                    <h5 class="m-b-10">List Report Transaction</h5>
                                    <form method="POST">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($ListRpt as $list) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= 'Rp ' . number_format($list->Amount); ?></td>
                                                            <td><?= $list->NamaRekening; ?></td>
                                                            <td><?= $list->NoRekening; ?></td>
                                                            <td><?= indo_date($list->CreatedDate); ?></td>
